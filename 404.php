...
<!-- Mirrored from htmldemo.net/zuka/zuka/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Dec 2025 05:28:52 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-5 text-center text-md-start">
                                    <figure class="error-img">
                                        <img src="assets/img/others/home_404.png" alt="404">
                                    </figure>
                                </div>
                                <div class="col-md-7 text-center text-md-start">
                                    <div class="error-text">
                                        ...
                                        <p class="max-w-70 max-md-90 mb--40 mb-md--30">Sorry, but the page you are looking for is not found. Please, make sure you have typed the current URL.</p>
                                        <a href="index.html" class="btn btn-medium btn-style-1">Back To Home</a>
                                    </div>
                                </div>
                            </div>
                        </div>
