...
<!-- Mirrored from htmldemo.net/zuka/zuka/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Dec 2025 05:28:51 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="default-color">
    ...
    <div class="wrapper">
                ...
                <div class="container">
                    <div class="row pt--80 pt-md--60 pt-sm--40 pb--75 pb-md--55 pb-sm--35">
                        <div class="col-md-5 order-md-1 order-2">
                            ...
                            <ul class="contact-info-2 mb--50">
                                <li class="contact-info__item">
                                    ...
                                    <span>  PO Box 16122 Collins Street West <br> Victoria 8007 Australia</span>
                                </li>
                                <li class="contact-info__item">
                        ...
                        <div class="col-md-7 order-md-2 order-1 mb-sm--30">
                            ...
                            <form class="form" action="https://htmldemo.net/zuka/zuka/mail.php" id="contact-form">
                                <div class="form__group mb--20">
                                    <input type="text" id="contact_name" name="contact_name" class="form__input" placeholder="Your name*">
                                </div>
                                <div class="form__group mb--20">
                                    <input type="email" id="contact_email" name="contact_email" class="form__input" placeholder="Email Address*">
                                </div>
                                <div class="form__group mb--20">
                                    <input type="text" id="contact_phone" name="contact_phone" class="form__input" placeholder="Your Phone*">
                                </div>
                                <div class="form__group mb--20">
                                    <textarea class="form__input form__input--textarea" id="contact_message" name="contact_message" placeholder="Message*"></textarea>
                                </div>
                                <div class="form__group">
                                    <input type="submit" value="Send" class="btn btn-submit btn-large btn-shape-round btn-style-1">
                                </div>
        ...
        <footer class="footer footer-3 border-top">
            <div class="footer-top pt--55">
                <div class="container-fluid">
                    <div class="row footer-row">
                        <div class="footer-column footer-column-1 order-first mb-lg--40 mb-sm--30 mb-xs--25">
                            <!-- Widget Start Here -->
                            <div class="footer-widget text-center text-sm-start">
                                <div class="textwidget mb--30">
                                    <a href="index.html" class="footer-logo">
                                        <img src="assets/img/logo/logo.png" alt="Logo" class="logo-img">
                                    </a>
                                </div>
                                <div class="textwidget mr--40">
                                    <p>Integer ut ligula quis lectus fringilla elementum porttitor sed est. Duis fringilla efficitur ligula sed lobortis.</p>
                                </div>
                            </div>
                            <!-- Widget End Here -->
                        </div>
                        <div class="footer-column footer-column-2 order-xl-2 order-3 mb-sm--25">
                            <!-- Widget Start Here -->
                            <div class="footer-widget text-center text-sm-start">
                                <h3 class="widget-title">Helful Link</h3>
                        ...
                        <div class="footer-column footer-column-3 order-xl-3 order-4 mb-sm--25">
                            <!-- Widget Start Here -->
                            <div class="footer-widget text-center text-sm-start">
                                <h3 class="widget-title">Company Link</h3>
                                <ul class="widget-menu">
                        ...
                        <div class="footer-column footer-column-4 order-xl-4 order-5 mb-xs--25">
                            <!-- Widget Start Here -->
                            <div class="footer-widget text-center text-sm-start">
                                <h3 class="widget-title">Openning Time</h3>
                                <ul class="widget-menu">
                        ...
                        <div class="footer-column footer-column-6 order-xl-6 order-2 mb-lg--40 mb-sm--30">
                            <div class="footer-widget text-center text-sm-start">
                                <h3 class="widget-title">MailChimp Signup Form</h3>
                                <!-- Subscribe widget Start Here -->
                                <div class="subscribe-widget mb--20">
            ...
            <div class="footer-bottom pt--55 pt-md--25 pb--25">
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-center">
...
<!-- Mirrored from htmldemo.net/zuka/zuka/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Dec 2025 05:28:52 GMT -->
</html>