...
<!-- Mirrored from htmldemo.net/zuka/zuka/blog-02-columns.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Dec 2025 05:28:55 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="col-sm-6 mb--40 mb-md--30 mb-sm--25">
                            <article class="post format-video">
                                <div class="post-media">
                                    ...
                                    <a href="https://www.youtube.com/watch?v=Rp19QD2XIGM" class="video-btn video-btn-2 video-popup">
                    ...
                    <div class="row pb--80 pb-md--60 pb-sm--50">
                        <div class="col-12">
                            <nav class="pagination-wrap">
                                <ul class="pagination">
                                    <li><a href="#" class="prev page-number"><i class="fa fa-arrow-left"></i></a></li>
                                    <li><span class="current page-number">1</span></li>
                                    <li><a href="#" class="page-number">2</a></li>
                                    <li><a href="#" class="page-number">3</a></li>
                                    <li><a href="#" class="next page-number"><i class="fa fa-arrow-right"></i></a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
